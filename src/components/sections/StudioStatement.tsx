...
export function StudioStatement() {
  ...
  return (
    ...
    >
      ...
      >
        Anwar Creative Studio is where Tamkin Anwar designs and builds independent software, one
        part of Anwar Ventures alongside Autowerks, Logistics, and Property Group.
      </p>
    </section>
  )
}
